    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            foreach (object node in linkedList)
            {
                if ((string)node == "sad")
                {
                    linkedList.Find(node).Value = "happy";
                }
                else if ((string)node == "sadness")
                {
                    linkedList.Find(node).Value = "happiness";
                }
            }
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            LinkedListNode<object> the2 = linkedList.Find("the");
            LinkedListNode<object> spain = linkedList.Find("Spain");
            LinkedListNode<object> inn = linkedList.Find("in");
            LinkedListNode<object> rain = linkedList.Find("rain");
            LinkedListNode<object> plain = linkedList.Find("plain");
            LinkedListNode<object> on = linkedList.Find("on");
            LinkedListNode<object> mainly = linkedList.Find("mainly");

            linkedList.Remove(rain);
            linkedList.Remove(inn);
            linkedList.Remove(plain);
            linkedList.Remove(mainly);

            linkedList.AddBefore(spain, rain);
            linkedList.AddBefore(spain, inn);
            linkedList.AddBefore(on, mainly);
            linkedList.AddAfter(the2, plain);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            LinkedListNode<object> d = anagram.Find("D");
            LinkedListNode<object> o1 = anagram.Find("O");
            LinkedListNode<object> r1 = anagram.Find("R");
            LinkedListNode<object> m = anagram.Find("M");
            LinkedListNode<object> i = anagram.Find("I");
            LinkedListNode<object> t = anagram.Find("T");
            LinkedListNode<object> o2 = anagram.FindLast("O");
            LinkedListNode<object> r2 = anagram.FindLast("R");
            LinkedListNode<object> y = anagram.Find("Y");

            anagram.Remove(o1);
            anagram.Remove(o2);

            anagram.AddAfter(r1, o1);
            anagram.AddAfter(r1, o2);
            ...
            anagram.AddAfter(d, y);
            anagram.AddAfter(d, t);
            anagram.AddAfter(d, r2);
