...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        private void TxtBoxEmpty__TextChanged(object sender, EventArgs e)
        {
            ...
            if (tb.Text.Length == 0)
            {
                //his.errorProvider.SetError(tb, "This field cannot be empty.");
                tb.Tag = false;
            }
            else
            {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if (herRadioButton.Checked == true)
            {
                person.eGender = genderPronoun.her;
            }
            if (themRadioButton.Checked == true)
            {
        ...
        private void himRadioButton_CheckedChanged(object sender, EventArgs e)
        {
